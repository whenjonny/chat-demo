  ...
  return (
    <div className={`flex-col ${styles['page']}`}>
      ...
      <div className={`flex-row items-end ${styles['group_2']}`}>
        ...
        <div className={`flex-col shrink-0 ${styles['section_3']}`}>
          ...
          <div className={`flex-row ${styles['section_10']} ${styles['space-x-80']}`}>
            <div className={`flex-row items-end shrink-0 self-center`}>
              <img
                className={`${styles['image']} ${styles['image_13']}`}
              ...
              />
              <div className={`flex-col items-center ${styles['group_14']} ${styles['space-y-8']}`}>
        ...
        <div className={`flex-col flex-auto ${styles['section_5']}`}>
          <div className={`flex-col`}>
            ...
            <div className={`flex-row justify-end ${styles['group_4']} ${styles['space-x-8-reverse']}`}>
          ...
          <div className={`flex-row ${styles['group_10']} ${styles['space-x-9']}`}>
            <img
            ...
            />
            <div className={`flex-col ${styles['group_11']} ${styles['space-y-8']}`}>
              ...
              <div className={`flex-col justify-start relative ${styles['group_12']}`}>
                ...
                <img
                  className={`${styles['image_12']} ${styles['pos_4']}`}
                  src="https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/63bccdc85a7e3f03104bfe58/63bccdf9c86a890011048e8a/16733178977341996262.png"
                />
              </div>
            </div>
            <img
              className={`self-center ${styles['image_11']}`}
              src="https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/63bccdc85a7e3f03104bfe58/63bccdf9c86a890011048e8a/a873ae6c6c840e2ec40e6680b77ef51c.png"
            />
          </div>
